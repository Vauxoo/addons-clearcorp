...
class sale_order_line(osv.osv):
    ...
    def _amount_line_no_discount(self, cr, uid, ids, field_name, arg,
                                 context=None):
    ...
    _columns = {
        'price_subtotal_not_discounted': fields.function(
            _amount_line_no_discount,
...
class SaleOrder(osv.osv):
    ...
    def _amount_all(self, cr, uid, ids, field_name, arg, context=None):
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            for line in order.order_line:
                ...
                res[order.id]['amount_untaxed_not_discounted'] += \
                    line.price_subtotal_not_discounted
                res[order.id]['amount_discounted'] += \
                    line.price_subtotal_not_discounted - line.price_subtotal
            ...
            if res[order.id]['amount_untaxed_not_discounted'] == 0:
                ...
                res[order.id]['order_discount'] = 100 * \
                    res[order.id]['amount_discounted'] / \
                    res[order.id]['amount_untaxed_not_discounted']
        return res
    ...
    _columns = {
        'amount_untaxed': fields.function(
            ...
            string='Subtotal With Discount', store={
        ...
        'order_discount': fields.function(
            ...
            multi='sums'),
        'amount_discounted': fields.function(
            _amount_all, digits_compute=dp.get_precision('Account'),
            string='Discount', store={
                'sale.order': (lambda self, cr, uid, ids, c={}: ids,
                               ['order_line'], 10),
            ...
            multi='sums'),
        'amount_untaxed_not_discounted': fields.function(
            _amount_all, digits_compute=dp.get_precision('Account'),
