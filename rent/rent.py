...
class rent_rent(osv.osv):
	...
	_columns = {
		...
		'rent_rent_local_id'    : fields.many2one('rent.floor.local','Local', states={'active':[('readonly',True), ('required',False)], 'finished':[('readonly',True),('required',False)]}),
		'rent_rent_parking_id'  : fields.many2one('rent.floor.parking','Parking', states={'active':[('readonly',True), ('required',False)], 'finished':[('readonly',True), ('required',False)]}),
		'rent_rent_estate_id'   : fields.many2one('rent.estate','Estate', states={'active':[('readonly',True), ('required',False)], 'finished':[('readonly',True), ('required',False)]}),
		...
		'rent_modif'            : fields.one2many('rent.rent', 'rent_modif_ref','Contract reference', states={'draft':[('readonly',True),('invisible',True)], 'finished':[('readonly',True)]}),
