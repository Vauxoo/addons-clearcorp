...
class rent_client(osv.osv):
	...
	_columns = {
		...
		'client_canton'    : fields.related('address', 'location_canton', type='selection', string='Canton'),
		'client_district'  : fields.related('address', 'location_district', type='selection', string='District'),
	}
rent_client()
