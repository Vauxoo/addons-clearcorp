        ...
        %for so in objects :
            ...
            <div id="wrapper">
                <table width = "100%" class = "document_data">
                    ...
                    <tr class = "title">
                        <td>${_("Invoice address")}</td><td>${_("Shipping address")}</td>
                    </tr>
                    <tr>
                        <td>${so.partner_invoice_id.street or ''}</td><td>${so.partner_shipping_id.street or ''}</td>
                    </tr>
                    <tr>
                        <td>${so.partner_invoice_id.street2 or ''}</td><td>${so.partner_shipping_id.street2 or ''}</td>
                    </tr>
                    <tr>
                ...
                <table id="responsibles_table">
                    <tr>
                        <td><b>${_("Realized by")}:</b> ${so.user_id.name}</td><td/><td><b>${_("Authorized by")}:_________________</b></td>
                    </tr>
                </table>
            </div>
        %endfor
